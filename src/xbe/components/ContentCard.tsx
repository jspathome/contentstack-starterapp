...
import { XBEImage } from '../models/XBEImage';

/**
 * Props for the ContentBlock component.
 * 
 * @interface ContentCardProps
 * @property {string} xbe_title - The title of the content block.
 * @property {string} xbe_content - The content of the content block.
 */
interface ContentCardProps {    
    [x: string]: any;
    xbe_image: XBEImage;
 ...
 *
 * @component
 * @param {ContentCardProps} props - The properties object.
 ...
 */
const ContentCard: React.FC<ContentCardProps> = ({ xbe_image, xbe_title, xbe_description, ...rest }) => {
    //console.log('ContentCard: ', xbe_title, xbe_description, rest.$);
    return (
        <div className='mb-1'>
                ...
                <div className="relative mx-auto max-w-2xl py-24 sm:py-32 lg:max-w-4xl">
                    ...
                    <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
                        <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
                            ...
                            <blockquote 
                                data-cslp={rest.$.xbe_description['data-cslp']}
                        ...
                        <div className="col-end-1 w-16 lg:row-span-4 lg:w-72">
                            <img
                                data-cslp={rest.$.xbe_image['data-cslp']}
                                alt=""
                                src={xbe_image.url}
                        ...
                        <figcaption className="text-base lg:col-start-1 lg:row-start-3">
                            <div data-cslp={rest.$.xbe_title['data-cslp']}
                                className="font-semibold text-gray-900">{xbe_title}</div>
