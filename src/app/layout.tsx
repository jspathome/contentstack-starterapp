...
import Header from "@/xbe/layouts/Header";
...
export const metadata: Metadata = {
  title: "SPELDEKAMPNL",
  applicationName: "speldekamp-nl",
};

/**
 * Configuration object for the viewport settings.
 * 
 * @property {string} themeColor - The theme color of the viewport.
 * @property {number} initialScale - The initial scale of the viewport.
 * @property {number} minimumScale - The minimum scale of the viewport.
 * @property {string} width - The width of the viewport, typically set to 'device-width'.
 */
...
/**
 * Represents a user with their personal details.
 * 
...
/**
 * An array of navigation items for the application.
 * Each navigation item contains the following properties:
 * - `name`: The display name of the navigation item.
 * - `href`: The URL path the navigation item links to.
 * - `current`: A boolean indicating whether the navigation item is currently active.
 */
const navigation = [
  { name: 'Home', href: '/', current: false },
  { name: 'Contact', href: '/contact', current: false },
  { name: 'Half width page', href: '/half-width-page', current: false },
  { name: 'Full width page', href: '/full-width-page', current: false },
  // { name: 'Projects', href: '#', current: false },
  // { name: 'Calendar', href: '#', current: false },
]

/**
 * An array of objects representing the user's navigation options.
 * Each object contains the following properties:
 * - `name`: The display name of the navigation option.
 * - `href`: The URL or link associated with the navigation option.
 */
 ...
 * It includes the HTML structure, meta tags, and navigation elements.
 *
  ...
  return (
    <html lang="en" className="h-full">
      <head>
        ...
        <meta name="description" content="SPELDEKAMPNL" />
